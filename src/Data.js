...
// ── SAMPLE DATA ──────────────────────────────────────────────────────────────
export const FLEET = [
  { plate:"SBA 1234 X", make:"Toyota", model:"Corolla", year:2022, color:"Silver", purchase:26000, insurance:1200, reg:1300, maint:7.5, coe:"2026-07-15", status:"On Rental" },
  { plate:"SBC 5678 Y", make:"Honda",  model:"Civic",   year:2021, color:"White",  purchase:22000, insurance:1100, reg:1100, maint:7.5, coe:"2028-03-20", status:"On Rental" },
  { plate:"SBD 9012 Z", make:"Mazda",  model:"3",       year:2023, color:"Blue",   purchase:29000, insurance:1400, reg:1600, maint:7.5, coe:"2028-11-10", status:"On Rental" },
  { plate:"SBE 3456 A", make:"Nissan", model:"Sylphy",  year:2022, color:"Black",  purchase:24500, insurance:1200, reg:1100, maint:7.5, coe:"2027-06-30", status:"Available" },
  { plate:"SBF 7890 B", make:"Toyota", model:"Vios",    year:2020, color:"Red",    purchase:19500, insurance:1000, reg:1000, maint:9.0, coe:"2025-09-15", status:"Maintenance" },
  { plate:"SBG 1122 C", make:"Honda",  model:"Jazz",    year:2021, color:"Grey",   purchase:20500, insurance:1050, reg:950,  maint:7.5, coe:"2026-08-22", status:"Available" },
  { plate:"SBH 3344 D", make:"Hyundai",model:"Elantra", year:2023, color:"White",  purchase:25000, insurance:1150, reg:1200, maint:7.5, coe:"2029-01-05", status:"On Rental" },
  { plate:"SBI 5566 E", make:"Kia",    model:"Cerato",  year:2022, color:"Silver", purchase:23000, insurance:1100, reg:1050, maint:7.5, coe:"2027-10-18", status:"Available" },
];
